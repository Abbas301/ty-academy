...
async function addMedicalDetails(req,res,next) {
    ...
    try {
        ...
        // user.currentMedicalHistory.prescription = images.cmhPrescription[0].path
        // user.currentMedicalHistory.investigationReport = images.cmhIR[0].path
        // user.pastMedicalHistory.prescription = images.pmhPrescription[0].path
        // user.pastMedicalHistory.investigationReport = images.pmhIR[0].path
        // user.previousSurgeries.prescription = images.psPrescription[0].path
        // user.previousSurgeries.investigationReport = images.psIR[0].path
        // user.previousTreatment.prescription = images.ptPrescription[0].path
        // user.previousTreatment.investigationReport = images.ptIR[0].path
        // user.recentInvestigation = images.recentIR[0].path
